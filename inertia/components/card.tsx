...
export function Card({ className, ...props }: CardBaseProps) {
    return (
        <div className={clsx("rounded-md border border-neutral-300 bg-white shadow-sm", className)} {...props} />
    )
}
...
export function CardTitle({ className, ...props }: CardBaseProps) {
    return <div className={clsx("text-xl text-black font-semibold leading-none tracking-tight", className)} {...props} />
}
